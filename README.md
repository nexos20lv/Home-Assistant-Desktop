...
- IntÃ©gration parfaite avec votre serveur Home Assistant local ou distant.
- Design Ã©purÃ© pour un accÃ¨s rapide Ã  vos entitÃ©s.
- Support du multi-plateforme grÃ¢ce Ã  Electron.

## ðŸ› ï¸ Installation
1. Clonez le dÃ©pÃ´t : git clone https://github.com/nexos20lv/Home-Assistant-Desktop.git
